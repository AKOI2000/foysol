        ...
        <div className="container" id="about-section">
          <div className="about-hero">
            ...
            <p>
              ...
              decisions. We provide end-to-end insurance guidance, tailored risk
              solutions, and practical training programs that strengthen
            ...
            <div className="grid col-2-by-1">
              ...
              <div className="text-box">
                <h4 className="heading-4">
                  ...
                  delivers tailored insurance solutions, risk management
                  strategies, and advisory support that keep businesses
                  protected, compliant, and positioned for long-term success.
                </h4>
