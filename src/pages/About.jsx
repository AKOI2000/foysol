...
function About() {
  return (
    <>
      <Seo
        title="About Us | Independent Insurance Advisory & Risk Consulting Firm"
        description="Learn about our insurance advisory approach, experience, and commitment to unbiased, client-first insurance guidance."
          ...
          <div className="container" id="about-section">
            <div className="about-hero">
              ...
              <p>
                ...
                consulting and risk advisory firm committed to helping
                organizations make smarter, safer, and more strategic business
                decisions. We provide end-to-end insurance guidance, tailored
                risk solutions, and practical training programs that strengthen
          ...
          <div className="container" id="story">
            ...
            <div className="grid col-1-by-2">
              <div className="grid col-2-by-1">
                ...
                <div className="grid col-2-by-1">
                  <img
                    src="https://res.cloudinary.com/dbn6k7pg6/image/upload/w_auto,f_auto,q_auto/v1768597211/story-1_rtu6tm.webp"
                    alt=""
                  />
                  <img
              ...
              <div className="grid col-2-by-1">
                <div className="img-box">
                  <img
                    src="https://res.cloudinary.com/dbn6k7pg6/image/upload/w_auto,f_auto,q_auto/v1768597159/about-stats_gwfm92.webp"
                    alt=""
                  />
                </div>
                ...
                <div className="text-box">
                  <h4 className="heading-4">
                    ...
                    precision, and strategic insight. FOYSOL Consulting &
                    Advisory delivers tailored insurance solutions, risk
                    management strategies, and advisory support that keep
                    businesses protected, compliant, and positioned for
                    long-term success.
                  </h4>
                  ...
                  <div className="about-stats-box">
                    <div className="about-stats-row">
                      ...
                      <div className="about-stat">
                        ...
                        <h4 className="heading-4 span">
                          Insurance Portfolios Reviewed
                        </h4>
                      </div>
                    </div>
                    <div className="about-stats-row">
